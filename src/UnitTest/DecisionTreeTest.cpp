...
BOOST_AUTO_TEST_SUITE_END() // OptimalSplitting


//BOOST_AUTO_TEST_SUITE(PrioritySplitting)
//
//class Fixture {
//public:
//	std::vector<Value> valueList;
...
//		args{1,2,3,4,5},
//		tree(decisionTree::buildNode(inSet, valueList, args,
//				decisionTree::PrioritySplitting<decisionTree::OptimalSplitting>()))
//	{
//	}
//};
//
...
//{
//	BOOST_CHECK_EQUAL(tree->get({1,2,3,4})->second, 1);
...
//	BOOST_CHECK_EQUAL(tree->get({1,2,3,4,5})->second, 1);
//}
//
//BOOST_AUTO_TEST_SUITE_END() // OptimalSplitting

BOOST_AUTO_TEST_SUITE_END() // DecisionTreeTest
